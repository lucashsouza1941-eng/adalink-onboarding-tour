...
- **108 passos** de tour: cada módulo abre sua tela real, ativa as abas internas (ex.: Memória → Memórias / Mapa / Execuções, Agentes → Especialistas / Conversa) e destaca cada função (busca, filtros, selos de status/modelo, botões, KPIs, grafo, busca semântica...).
